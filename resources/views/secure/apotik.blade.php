...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <br>
            <br>
            <div class="room-container" id="apotik">
                @if (session('error'))
                            ...
                            <div class="card-body text-center">
                                <div class="bg-primary rounded-circle d-inline-block p-3">
                                    <h2 class="text-white m-0" id="nomor_antrian">
                                        @if ($currentQueue && $currentQueue->ruangan === 'apotik')
                                            {{ $currentQueue->nomor }}
                                        @else
                                            0
                                        @endif
                                ...
                                <h3 class="card-title mt-3">Apotik</h3>
                                ...
                                @if (!$currentQueueNumber)
                                    <form method="POST"
                                        action="{{ route('admin.startQueueApotik', ['ruangan' => 'apotik']) }}">
                                        @csrf
                                ...
                                @else
                                    ...
                                    <form method="POST"
                                        action="{{ route('admin.selesaikanAntrianApotik', ['ruangan' => 'apotik']) }}"
                                        class="d-flex flex-column mt-3">
                                        @csrf
                                        <input type="hidden" name="nomor_antrian" value="{{ $currentQueue->id }}">
                        ...
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="apotik_queue_body">
                                        @if (isset($allQueues['apotik']))
                                            @foreach ($allQueues['apotik'] as $queue)
                                                <tr>
                                                    <td>{{ $queue->nomor }}</td>
                                                    <td>{{ $queue->nama }}</td>
                                                    <td>
